...
const fullName = runners.forEach(placeHolder => console.log(`${placeHolder.first_name} ${placeHolder.last_name}`));
...
const allCaps = runners.map(placeHolder => placeHolder.first_name.toUpperCase());
...
const largeShirts = runners.filter(placeHolder => placeHolder.shirt_size === "L" );
...
// const totalLandArea = cityData.reduce(function(banana, currentValue) {
//   debugger;
//   return banana + currentValue.population;
  
// }, 0);

const ticketPriceTotal = runners.reduce((addLot, placeHolder) => addLot + placeHolder.donation, 0)
